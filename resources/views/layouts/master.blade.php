...
<head>
    ...
    <title>Panaderia: La Buena Sazón</title>
        ...
        <div class="container">
            <div class="col-sm-12">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}"><i class="entyp-feather"></i>Buena Sazon</a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="{{ url('blog') }}">
                                ...
                                <hr/>
                                <div class="small">Ultimas noticias</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('about') }}">
                        ...
                        <li>
                            <a href="{{ url('contact') }}">
                                ...
                                <hr/>
                                <div class="small">Encuentranos</div>
                            </a>
                        </li>
